...
void CL_ClampPitch (void)
{
	...
	pitch = SHORT2ANGLE (cl.frame.playerstate.pmove.delta_angles[0]);
	if (pitch > 180)
		pitch -= 360;
...
{
	cl.viewangles[0] = -SHORT2ANGLE (cl.frame.playerstate.pmove.delta_angles[0]);
}
...
void CL_SendCmd (void)
{
	...
	*cmd = CL_CreateCmd ();
	...
	{
		if (cls.netchan.message.cursize || sys_currmsec - cls.netchan.last_sent > 1000)
